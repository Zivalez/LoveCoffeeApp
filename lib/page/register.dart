          ...
          child: Column(  
            ...
            children: [  
                ...
                children: [  
                  ...
                  Container(  
                    ...
                    decoration: BoxDecoration(  
                      color: Colors.green, // Warna hijau kece  
                      borderRadius: BorderRadius.circular(10.0), // Rounded biar keren  
                    ),  
                    child: Icon(  
              ...
              Column(  
                ...
                children: [  
                  // Input Name  
                  Text("Name", style: TextStyle(fontSize: 16.0, fontWeight: FontWeight.w600)),  
                  TextFormField(   
                  ...
                  // Input Email  
                  Text("Email", style: TextStyle(fontSize: 16.0, fontWeight: FontWeight.w600)),  
                  TextFormField(   
                  ...
                  // Input Password  
                  Text("Password", style: TextStyle(fontSize: 16.0, fontWeight: FontWeight.w600)),  
                  TextFormField(   
