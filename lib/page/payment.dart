    ...
    showDialog(  
      ...
      builder: (BuildContext context) {  
        return AlertDialog(  
          ...
          content: Text('Pembayaran Anda sebesar Rp${(_totalPrice + _deliveryFee + _serviceFee).toStringAsFixed(0)} telah berhasil.'),  
          actions: [  
            TextButton(  
              onPressed: () async {  
                setState(() {  
                ...
                if (success) {  
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(  
                    SnackBar(content: Text('Gagal menghapus item dari keranjang')),  
                  );  
                }  
