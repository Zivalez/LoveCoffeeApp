  ...
  void _login() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        final result = await LoginService().login(name, password);  // Gunakan LoginService()
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              Column(  
                crossAxisAlignment: CrossAxisAlignment.start, // Agar elemen di bawahnya rata kiri  
                children: [  
                  Container(  
                    padding: EdgeInsets.all(10.0), // Padding untuk memperbesar kotak  
                  ...
                  SizedBox(height: 5.0), // Jarak antara teks "Login" dan deskripsi  
                  Text(  
              ...
              Column(  
                ...
                children: [  
                  ...
                  TextFormField( // Ganti TextField dengan TextFormField  
                    ...
                    obscureText: true, // Menggunakan karakter tersembunyi untuk password  
                    decoration: InputDecoration(  
                ...
                children: [  
                  Container(  
                    ...
                    child: ElevatedButton(  
                      ...
                      style: ElevatedButton.styleFrom(  
                        backgroundColor: Color.fromARGB(255, 85, 166, 48),  
                  ...
                  TextButton(  
                    ...
                    child: Text(  
                      ...
                      style: TextStyle(  
                        color: Color.fromARGB(255, 85, 166, 48),  
                        fontSize: 16.0,  
                      ),  
                    ),  
                  ),  
