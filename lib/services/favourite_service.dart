...
class FavouriteService {  
  ...
  final String baseUrl = 'https://67535e17f3754fcea7bb8e98.mockapi.io/api/v1/users';  
  ...
  Future<bool> addToFavourite(String itemId, Map<String, dynamic> itemDetails) async {  
    try {  
      // Cek dulu ID user  
      ...
      if (response.statusCode == 200) {  
        ...
        bool isExists = favourites.any((item) => item['itemname'] == itemDetails['itemname']);  
        if (isExists) {  
