...
class CartTile extends StatelessWidget {  
            ...
            Container(  
              ...
              decoration: BoxDecoration(  
                ...
                image: DecorationImage(  
                  image: AssetImage('assets/images/${_getImageNameFromItemName(cartItem.itemName)}'),  
                  fit: BoxFit.cover,  
                ),  
                color: Colors.white, // Warna background jika gambar gagal dimuat  
              ),  
  ...
  void _updateQuantity(int newQuantity) async {  
    ...
    try {  
      ...
      final updatedItem = await cartService.updateQuantity(  
        cartItem.id,   
        newQuantity  
      );  
