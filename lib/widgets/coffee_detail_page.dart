...
class _CoffeeDetailPageState extends State<CoffeeDetailPage> {  
  ...
  Future<void> _toggleFavourite() async {  
    ...
    if (_isFavourite) {  
      ...
      result = await _favouriteService.addToFavourite(widget.name, favouriteItem);  
    }  
      ...
      switch (widget.name) {  
        case 'Matcha Latte':  
          return {  
            ...
            'about': 'Matcha Latte is a drink that combines the deliciousness of japanese green tea powder (matcha) with the creaminess of milk.',  
            'price': 18.000,  
          };  
        case 'Iced Salted Caramel Latte':  
          return {  
            'tags': ['Coffee', 'Caramel', 'Cold Brew'],  
            'about': 'A refreshing cold latte with a perfect balance of sweet salted caramel and smooth espresso, served over ice.',  
            'price': 22.500,  
          };  
        case 'Chai Latte':  
          return {  
            'tags': ['Tea', 'Spices', 'Warm Drink'],  
            'about': 'A traditional Indian-style tea blended with aromatic spices like cinnamon, cardamom, and ginger, mixed with steamed milk.',  
            'price': 15.000,  
          };  
        case 'Oat Milk Latte':  
          return {  
            'tags': ['Coffee', 'Plant-based', 'Dairy Free'],  
            'about': 'A creamy latte made with smooth oat milk, offering a nutty flavor and a sustainable dairy-free alternative.',  
            'price': 20.000,  
          };  
        case 'Peppermint Tea':  
          return {  
            'tags': ['Herbal', 'Soothing', 'Caffeine-Free'],  
            'about': 'A refreshing herbal tea made from pure peppermint leaves, known for its cooling sensation and digestive benefits. Offers a crisp, minty flavor that helps relax and calm the mind.',  
            'price': 12.000,  
          }; 
        case 'Fruit Tea':  
          return {  
            'tags': ['Fruity', 'Refreshing', 'Cold Drink'],  
            'about': 'A vibrant and refreshing tea infused with a blend of fresh seasonal fruits, perfect for a cool and tangy experience.',  
            'price': 10.000,  
          };  
        case 'Floral Tea':  
          return {  
            'tags': ['Herbal', 'Delicate', 'Aromatic'],  
            'about': 'A delicate tea blend featuring subtle floral notes, creating a soothing and elegant drinking experience.',  
            'price': 15.000,  
          };  
        case 'Ginger Tea':  
          return {  
            'tags': ['Herbal', 'Spicy', 'Warming'],  
            'about': 'A warming tea made with fresh ginger, known for its comforting properties and bold, spicy flavor.',  
            'price': 10.000,  
          };  
        case 'French Fries':  
          return {  
            'tags': ['Snack', 'Crispy', 'Potato'],  
            'about': 'Golden and crispy potato fries, perfectly seasoned and fried to a delightful crunch.',  
            'price': 18.000,  
          };  
        case 'Waffle Ice Cream':  
          return {  
            'tags': ['Dessert', 'Sweet', 'Cold'],  
            'about': 'A classic dessert featuring a warm, crispy waffle topped with creamy, rich ice cream and sweet toppings.',  
            'price': 20.500,  
          };  
        case 'French Toast':  
          return {  
            'tags': ['Breakfast', 'Sweet', 'Bread'],  
            'about': 'Soft bread dipped in a rich egg mixture, fried to golden perfection, and served with maple syrup and butter.',  
            'price': 18.000,  
          };  
        case 'Croffle':  
          return {  
            'tags': ['Pastry', 'Fusion', 'Crispy'],  
            'about': 'A delightful fusion of croissant and waffle, creating a crispy, flaky pastry with a unique texture and flavor.',  
            'price': 12.00,  
          };  
        default:  
          return {  
                ...
                children: [  
                  ...
                  Container(  
                    ...
                    child: Row(  
                      ...
                      children: [  
                        for (int i = 0; i < coffeeDetails['tags'].length; i++) ...[  
                          Text(  
